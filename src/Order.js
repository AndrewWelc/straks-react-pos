  ...
  queryCurrency(currency) {
    ...
    fetch(query)
      ...
      .then(d => {
        ...
        window.Materialize.toast('Exchange Rate Fetched!<br />1 STAK = ' 
                ...
                <form>
                  <Row>
                    <Col s={12} l={12} xl={12} className="offset-l0 offset-xl0">
                      ...
                      <Col s={6} l={4} xl={4} >
                        ...
                        <div className="subtotal-right">{parseFloat(this.state.totalBch).toFixed(8)} STAK</div>
                      </Col>
                      <Col s={6} l={4} xl={4} >
                  ...
                  <Row>
                    ...
                    <Col s={4} l={4} xl={4} className="offset-l0 offset-xl0">
                      ...
                      <div className="subtotal-right">{parseFloat(this.state.subtotalBch).toFixed(8)} STAK</div>
                    </Col>
                  </Row>
                </form>
              </div>
