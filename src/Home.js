        ...
        <Container>
         <br />{greeting}<br />
          <CardPanel className="grey lighten-3 grey-text">
            ...
            <Row>
              <Col s={12} l={4} className='grid-index action'><NavLink to="/order"><Button large waves='light' className="stakBlue darken-4 btn-action"><Icon left>shopping_cart</Icon>ORDER</Button></NavLink></Col>
              <Col s={12} l={4} className='grid-index action'><NavLink to="/payment"><Button large waves='light' className="stakBlue darken-4 btn-action"><Icon left>payment</Icon>PAYMENT</Button></NavLink></Col>
              <Col s={12} l={4} className='grid-index action'><NavLink to="/ledger"><Button large waves='light' className="stakBlue darken-4 btn-action"><Icon left>list</Icon>LEDGER</Button></NavLink></Col>
              {
