    ...
    if(!this.state.received && !this.state.verify){
      return (
        ...
        <Container>
          ...
          <ul>            
            <li>Amount: {this.state.amount} {this.state.currency} - {this.state.bch} STAK</li>
            <li>Address: <a target="_blank" href={"https://straks.info/en/address/" + this.state.addr}>{this.state.addr}</a></li>
          ...
          <Row>
            <Col s={12} l={6} className="offset-l3">
              <CardPanel className="green white-text">
                <span>
                  <h3>PAID {this.state.bch} STAK!</h3>
